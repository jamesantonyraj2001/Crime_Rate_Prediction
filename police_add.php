...
?>
     ...
     function f1()
    {
      ...
      var sta4=document.getElementById("pas").value;
      var x=sta.trim();
      var x1=sta1.indexOf(' ');
      var x2=sta2.trim();
      var x3=sta3.indexOf(' ');
		 ...
		 <div class="bg-agile">
			...
			<div class="login-form"><p><h2>Log Police Officer</h2></p><br>	
				<form action="#" method="post" style="color: gray">Police Name
                    ...
                    Location of Police Officer<input type="text" required  name="location" placeholder="location" id="pspec" required onfocusout="f1()">
          <br>
